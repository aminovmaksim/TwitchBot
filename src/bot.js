...
const general_questions = [
  ...
  ", почему мотыльки скапливаются на свету?",
  ", зачем мурлыкают кошки?",
  ", почему зевота заразительна?",
  ", как части тела «понимают», что больше не нужно расти?",
  ", откуда птицы знают, куда нужно лететь?",
  ", почему плацебо всегда срабатывает?",
  ", что находится на дне океана?",
  ", можно ли путешествовать во времени?",
  ", почему большинство людей — правши?",
  ", почему мы зеваем?",
  ", почему снятся сны?",
  ", почему человек привык спать?",
  ", из чего состоит Вселенная?",
  ", из чего состоит черная дыра?",
  ", откуда взялась гравитация?",
  ", есть ли еще жизнь во Вселенной?",
  ", в чем смысл жизни?",
  ", почему я задаю тупые вопросы?",
  ", тебе нравиться стример?"
]
